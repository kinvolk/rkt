...
// access it by the names specified in libs and returning the first that is
// successfully opened. Callers are responsible for closing the handler.  If no
// library can be successfully opened, an error is returned.
